...
public class TelephoneDialPadSteps extends Base {
    ...
    public void i_have_the_digit(String value) {
        this.input = value;
        logInfo("The given input digit is " + input);
    }

    @When("I retrieve all possible combinations")
    public void iRetrieveAllPossibleCombinations() {

        result = TelephoneDialPad.retrieveCombinations(input);
        actualCombinations = (List<String>) result;
        logInfo("The actual combination generated by Telephone dail pad " + actualCombinations);
    }

    @Then("the result should contain {string}")
    public void the_result_should_contain(String value) {
        List<String> expectedCombinations = Arrays.asList(value.split(",\\s*"));
        ...
        logSuccess("The actual combinations size [" + actualCombinations.size()
                + "]  match the expected combination size ["
                + actualCombinations.size() + "]");
    }

    @Given("I have the input {string}")
    public void I_have_the_input(String value) {
        this.input = value;
        logInfo("The given input  is " + input);
    }
